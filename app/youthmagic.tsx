...
const imgUrl = 'https://i.imgur.com/xxCSbLb.png';
...
export default function App() {
    ...
    const grow = () => {
        if(firstCount == secondCount && secondCount == thirdCount)
            router.navigate('resultmagician');
        else if (secondCount == 0 || firstCount == 0)
            router.navigate('resultsorcerer');
        else if (thirdCount > firstCount && thirdCount > secondCount)
            router.navigate('resultsorcerer');
        else router.navigate('resultmagician');
    };

    return (
        <View style = {styles.container}>
            <View style = {{ height: 100}}>
                <Text style = {{ textAlign: 'center', fontSize: 40, fontWeight: 'bold' }}>마법학을 즐기는 청년</Text>
            </View>
                ...
                <View style = {styles.container}>
                    ...
                    {clickableOne ?
                        ...
                        (<TouchableOpacity style = {styles.inactiveBtn}>
                            <Text style = {styles.textst}>사교활동</Text>
                        </TouchableOpacity>)
                    }
                </View>
                <View style = {styles.container}>
                    ...
                    {clickableTwo ?
                        ...
                        :
                        (<TouchableOpacity style = {styles.inactiveBtn}>
                            <Text style = {styles.textst}>신학 수업</Text>
                        </TouchableOpacity>)
                    }
                </View>
                <View style = {styles.container}>
                    ...
                    {clickableThree ?
                        ...
                        :
                        (<TouchableOpacity style = {styles.inactiveBtn}>
                            <Text style = {styles.textst}>무술 수업</Text>
                        </TouchableOpacity>)
                    }
                </View>
            </View>
