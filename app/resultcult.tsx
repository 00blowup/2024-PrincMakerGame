...
const imgUrl = 'https://i.imgur.com/wN8HJbv.png';
          ...
          <ScrollView>
            <View style={styles.container}>
                ...
                <View style = {{ width: 300, marginTop: 20, marginBottom: 50 }}>
                    ...
                    <Text>그 뒤로 왕자가 어디에 있는지, 살아있기는 한지, 아무것도 알 수 없었습니다. 그런데... 왕자가 떠난 후 몇 년이 지났을 무렵, 왕자와 매우 닮은 거짓 선지자가 백성들 사이에 위세를 떨친다는 풍문이 들려옵니다.</Text>
                </View>
            </View>
          </ScrollView>
        </SafeAreaView>
